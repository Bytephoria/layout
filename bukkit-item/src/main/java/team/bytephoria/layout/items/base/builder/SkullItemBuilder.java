...
public class SkullItemBuilder extends ItemBuilder<SkullItemBuilder, SkullItem> {
     ...
     * @return this builder
     */
    public SkullItemBuilder fromProfile(final @NotNull PlayerProfile playerProfile) {
     ...
     * @return this builder
     */
    public SkullItemBuilder fromBase64(final @NotNull String base64Texture) {
     ...
     * @return this builder
     */
    public SkullItemBuilder fromTextureId(final @NotNull String skinId) {
        this.playerProfile = Bukkit.createProfile(UUID.randomUUID());
