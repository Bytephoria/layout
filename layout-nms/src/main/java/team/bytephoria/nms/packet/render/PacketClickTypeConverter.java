...
public final class PacketClickTypeConverter {

    private PacketClickTypeConverter() {
        throw new UnsupportedOperationException("This class cannot be instantiated.");
    }

    @Contract(pure = true)
    public static @NotNull ItemClickType fromNms(final @NotNull ClickType input, final int button) {
        return switch (input) {
